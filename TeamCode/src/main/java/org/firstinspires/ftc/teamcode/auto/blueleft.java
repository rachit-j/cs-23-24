...
//        }
    ...
    public void MOVETOBACKDROP(){
        ...
        intake.setPower(0);
        robot.boxup();
        runtime.reset(); while (runtime.seconds() < 1) {stay(24, -50, 90);}
    }
    public void AUTONOMOUS_A(){
        ...
        //move to deposit position
        runtime.reset(); while (runtime.seconds() < 2) {stay(36, -20, 90);}

        //deposit
        runtime.reset(); while (runtime.seconds() < 0.5) {stay(40, -20, 90);}
        runtime.reset(); while (runtime.seconds() < 0.5) {
            stay(40, -20, 90);
            robot.releasetwo();
        }
    ...
    public void AUTONOMOUS_B(){
        ...
        //move to deposit position
        runtime.reset(); while (runtime.seconds() < 2) {stay(36, -25, 90);}

        //deposit
        runtime.reset(); while (runtime.seconds() < 0.5) {stay(40, -25, 90);}
        runtime.reset(); while (runtime.seconds() < 0.5) {
            stay(40, -25, 90);
            robot.releasetwo();
        }
    ...
    public void AUTONOMOUS_C(){
        ...
        //move to deposit position
        runtime.reset(); while (runtime.seconds() < 2) {stay(36, -30, 90);}

        //deposit
        runtime.reset(); while (runtime.seconds() < 0.5) {stay(40, -30, 90);}
        runtime.reset(); while (runtime.seconds() < 0.5) {
            stay(40, -30, 90);
            robot.releasetwo();
        }
